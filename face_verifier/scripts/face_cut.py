from mysite.settings import ON_SERVER
...
if ON_SERVER:
    ...
    def get_faces(i, path):
        try:
            pics_getted = cropper_divider(path)[::-1]
        except Exception as e:
            return i + str(e)
        return pics_getted
else:
    def get_faces(i, path):
        return ['erytr/media/recognition/cropped/avatar_04MOfzm.jpg', '/media/recognition/cropped/avatar_0KGgv0s.jpg',
                '/media/recognition/cropped/avatar_1Wwju5h.jpg']
    ...
    def get_faces(path_first, path_sec):
        try:
            first_getted = cropper_divider(path_first)[::-1]  # self (2)
        ...
        try:
            sec_getted = cropper_divider(path_sec)[::-1]  # doc (1)
