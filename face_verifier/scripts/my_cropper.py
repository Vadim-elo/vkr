...
class Cropper:
    ...
    * `fix_gamma`: `bool`, default=`True`
    ...
    def __init__(
        ...
        # XML Resource
        # directory = str(BASE_DIR) + str('my_cropper.py')
        # directory = os.path.dirname(sys.modules["my_cropper.py"].__file__)
        self.casc_path = os.path.join(BASE_DIR, CASCFILE)
    ...
    def crop(self, path_or_array):
        ...
        return faces, image, gray, img_height, img_width

    def cropping(self, faces, image, gray, img_height, img_width, face_id):
